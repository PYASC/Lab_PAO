...
public interface IStock {
    ...
    void removeExpiredBatches(); /// remove all batches that have expired; should be called at the start of each day to make sure there are no expired products in the stock
}
